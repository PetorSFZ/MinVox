...
SkyCubeObject::SkyCubeObject() noexcept
{
	...
	const float uvCoords[] ={ // Slight hack to remove "edge" from textures.
							  // u, v
							  // Left
		0.05f, 0.05f, // 0, left-bottom-back
		0.95f, 0.05f, // 1, left-bottom-front
		0.05f, 0.95f, // 2, left-top-back
		0.95f, 0.95f, // 3, left-top-front

					  // Right
		0.95f, 0.05f, // 4, right-bottom-back
		0.05f, 0.05f, // 5, right-bottom-front
		0.95f, 0.95f, // 6, right-top-back
		0.05f, 0.95f, // 7, right-top-front

					  // Bottom
		0.05f, 0.05f, // 8, left-bottom-back
		0.05f, 0.95f, // 9, left-bottom-front
		0.95f, 0.05f, // 10, right-bottom-back
		0.95f, 0.95f, // 11, right-bottom-front

					  // Top
		0.05f, 0.95f, // 12, left-top-back
		0.05f, 0.05f, // 13, left-top-front
		0.95f, 0.95f, // 14, right-top-back
		0.95f, 0.05f, // 15, right-top-front

					  // Back
		0.95f, 0.05f, // 16, left-bottom-back
		0.95f, 0.95f, // 17, left-top-back
		0.05f, 0.05f, // 18, right-bottom-back
		0.05f, 0.95f, // 19, right-top-back

					  // Front
		0.05f, 0.05f, // 20, left-bottom-front
		0.05f, 0.95f, // 21, left-top-front
		0.95f, 0.05f, // 22, right-bottom-front
		0.95f, 0.95f  // 23, right-top-front
	};
...
void SkyCubeObject::render() noexcept
{
	glBindVertexArray(vertexArrayObject);
